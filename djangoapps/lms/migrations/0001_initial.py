# Generated by Django 3.1.1 on 2020-09-28 20:55
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('person', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='erp.person')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, null=True)),
                ('updated_at', models.DateTimeField(auto_now=True, null=True)),
                ('admin', models.ForeignKey(limit_choices_to={'is_admin': True}, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='admin_in', to='erp.person')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True, null=True)),
                ('learning', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='lms.learning')),
                ('person', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='erp.person')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='learning',
            name='students',
            field=models.ManyToManyField(related_name='learn_in', through='lms.RoleStudent', to='erp.Person'),
        ),
        migrations.AddField(
            model_name='learning',
            name='teachers',
            field=models.ManyToManyField(related_name='teach_in', through='lms.RoleTeacher', to='erp.Person'),
        ),
        migrations.AddField(
            model_name='decision',
            name='presence',
