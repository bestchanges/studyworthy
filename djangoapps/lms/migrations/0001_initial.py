...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('code', models.CharField(default=uuid.uuid4, max_length=200, unique=True)),
                ('name', models.CharField(max_length=200)),
                ('type', models.CharField(choices=[('text/plain', 'Text'), ('text/html', 'Html'), ('text/markdown', 'Markdown'), ('link/uri', 'Link'), ('video/youtube', 'Video'), ('lms/task', 'Task')], default='text/html', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.SlugField(default=uuid.uuid4, max_length=70, unique=True)),
                ...
                ('authors', models.ManyToManyField(blank=True, to='lms.Author')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('code', models.SlugField(default=uuid.uuid4, max_length=100, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('state', models.CharField(choices=[('hidden', 'Hidden'), ('closed', 'Closed'), ('opened', 'Opened'), ('finished', 'Finished'), ('cancelled', 'Cancelled')], max_length=20)),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, null=True)),
                ('updated_at', models.DateTimeField(auto_now=True, null=True)),
                ('learning', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='lms.learning')),
            ],
        ),
        migrations.CreateModel(
            name='Person',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=200)),
                ('code', models.SlugField(default=uuid.uuid4)),
                ('order', models.IntegerField()),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('code', models.SlugField(default=uuid.uuid4, help_text='Short code to easily identify this unit across the Course')),
                ('name', models.CharField(max_length=200)),
                ('description', models.TextField(blank=True, null=True)),
        ...
        migrations.AddField(
            model_name='unit',
            name='section',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='lms.section'),
        ),
        migrations.CreateModel(
            name='Teacher',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('bio', models.TextField(blank=True, null=True)),
                ('person', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='lms.person')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True, null=True)),
                ('learning', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='lms.learning')),
                ('person', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='lms.person')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code_repository', models.CharField(blank=True, max_length=255, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assigned_at', models.DateTimeField(blank=True, null=True)),
                ('checked_at', models.DateTimeField(blank=True, null=True)),
                ('decision', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='lms.decision')),
                ('reviewer', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='lms.roleteacher')),
            ],
        ),
        migrations.CreateModel(
            name='Presence',
            fields=[
                ...
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='lms.rolestudent')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='learning',
            name='admin',
            field=models.ForeignKey(limit_choices_to={'is_admin': True}, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='admin_in', to='lms.person'),
        ),
        migrations.AddField(
            model_name='learning',
            name='course',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='lms.course'),
        ),
        migrations.AddField(
            model_name='learning',
            name='students',
            field=models.ManyToManyField(related_name='learn_in', through='lms.RoleStudent', to='lms.Person'),
        ),
        migrations.AddField(
            model_name='learning',
            name='teachers',
            field=models.ManyToManyField(related_name='teach_in', through='lms.RoleTeacher', to='lms.Person'),
        ),
        migrations.AddField(
            model_name='decision',
            name='presence',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='lms.presence'),
        ),
        migrations.AddField(
            model_name='author',
            name='person',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='lms.person'),
        ),
        migrations.CreateModel(
            name='Admin',
            fields=[
